...
public class FileSystemStorageService implements StorageService {
    ...
    @Override
    public String store(MultipartFile file, List<String> graduatoriaFianle) throws IOException {
        String filename = StringUtils.cleanPath(file.getOriginalFilename());


        String filenameGra="Graduatoria.csv";
        System.out.println("PATH"+  this.rootLocation);

        String localPath="C:\\Users\\endriazizi\\Documents\\sviluppo_corsi\\graduatoria-service\\uploads\\Graduatoria.csv";

//        FileWriter writer = new FileWriter(this.rootLocation+filenameGra);
